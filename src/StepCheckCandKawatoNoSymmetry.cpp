/** @file StepCheckCandKawatoNoSymmetry.cpp
 *  Implementation of the StepCheckCandKawatoNoSymmetry class.
 */
...
StepCheckCandKawatoNoSymmetry::StepCheckCandKawatoNoSymmetry() : 
	m_rotatedImg(NULL),
...
void StepCheckCandKawatoNoSymmetry::PrepareImg(IplImage *src)
{
...
int StepCheckCandKawatoNoSymmetry::DoCheckPair(const Candidate &cand1, const Candidate &cand2, IplImage *grayImg)
{
...
int StepCheckCandKawatoNoSymmetry::DoCheckSingle(const Candidate &cand)
{
